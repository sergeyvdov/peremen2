...
public class Main {
    public static void main(String[] args) {
        ...
        byte pen = 5;
        System.out.println("Значение переменной" + " pen" + " с типом" + " byte" + " равно" + " 5.");
        short milk =754;
        System.out.println("Значение переменной" + " milk" + " с типом" + " short" + " равно" + " 754.");
        int car = 44521;
        System.out.println("Значение переменной" + " car" + " с типом" + " int" + " равно" + " 44521");
        long star = 9365654789L;
        System.out.println("Значение переменной" + " star" + " с типом" + " long" + " равно" + " 9365654789");
        float candy = 3.5f;
        System.out.println("Значение переменной" + " candy" + " с типом" + " float" + " равно" + " 3.5.");
        double apple = 4.25655896;
        System.out.println("Значение переменной" + " apple" + " с типом" + " double" + " равно" + " 4.25655896.");
        float a = 27.12f;
        ...
        short sevenKilograms = 7000;
        a = 250;
        b = 500;
        float numberOfDaysA = sevenKilograms/a;
        System.out.println(numberOfDaysA + " дней уйдет на похудение спортсмена если он будет терять в день по 250 грамм.");
        long numberOfDaysB = sevenKilograms/b;
        System.out.println(numberOfDaysB + " дней уйдет на похудение спортсмена если он будет терять в день по 500 грамм.");
